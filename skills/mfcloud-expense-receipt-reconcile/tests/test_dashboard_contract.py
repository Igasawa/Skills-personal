...
def test_api_router_registers_expected_routes() -> None:
    ...
    expected_paths = {
        ...
        "/api/workflow-events/notification-settings/test",
...
def test_dashboard_templates_reference_expected_script_chunks() -> None:
    ...
    html = {
        base / "index.html": [
            ...
            "/static/js/index.state.validation.js",
            "/static/js/index.state.workflow.js",
            "/static/js/index.api.js",
            "/static/js/index.api.transport.js",
            "/static/js/index.api.commands.js",
