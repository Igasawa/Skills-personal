...
def test_workspace_page_shows_core_link_and_prompt_tools(
    ...
    assert "/static/js/workspace.state.js" in res.text
    assert "/static/js/workspace.links.js" in res.text
    assert "/static/js/workspace.prompt.js" in res.text
    assert "/static/js/workspace.sync.js" in res.text
    assert "/static/js/workspace.render.js" in res.text
