    ...
    if args.preflight:
        ...
        preflight_out = run_node_playwright_script(
            ...
            args=[
                ...
                *(["--skip-amazon"] if getattr(args, "skip_amazon", False) else []),
                *(["--skip-rakuten"] if getattr(args, "skip_rakuten", False) else []),
                *(["--skip-mfcloud"] if getattr(args, "skip_mfcloud", False) else []),
